    ...
    <body id="home">
        <body id="home">
            ...
            <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
              <div class="container">
                <a href="index.html" class="navbar-brand logo"> CDC </a>
                <button
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul class="navbar-nav ms-auto" dir="rtl">
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#">هەواڵ</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#">خۆ تومارکردن</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#">چوونەژورەوە</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end me-0">
                        <li>
                          <a class="dropdown-item text-end" href="#">گەشەپێدەران</a>
                        </li>
                        <li>
                          <a class="dropdown-item text-end" href="#">مامۆستایان</a>
                        </li>
                        <li>
                          <a class="dropdown-item text-end" href="#">خۆبەخشەکان</a>
                        </li>
                        <li>
                          <a class="dropdown-item text-end" href="#">ئێلمنەرەکان</a>
                        </li>
                      </ul>
                    </li>
                  </ul>
