            ...
            <div class="activity">
                ...
                <div class="activity-data">
                    ...
                    <div class="data status">
                        ...
                        @foreach($registerrequest as $registerrequests)
                        <a href="{{url('Aprove',$registerrequests->id)}}"    class="btn btn-success btn-sm m-1" ><i class="material-icons"  title="Aprove">Aprove</i></a>
                    ...
                    <div class="data status">
                        ...
                        @foreach($registerrequest as $registerrequests)
                        <a href="{{url('cancel',$registerrequests->id)}}"    class="btn btn-danger btn-sm m-1" ><i class="material-icons"  title="Delete">Reject</i></a>
